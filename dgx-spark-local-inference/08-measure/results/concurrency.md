...
Taken with the original concurrency harness; `llm-concurrency.py` in the folder
above implements the same protocol for any server. Protocol: 400 output tokens, `min_tokens`
